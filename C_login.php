...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        {
            //fetch from database
            $query = "SELECT email,password FROM company WHERE Email = '$email' limit 1 ";
            ...
            if($result){
                if($result && mysqli_num_rows($result) > 0)
				{
					...
					if(password_verify($password, $user_data['password']))
					{
                        ...
                        $logintime = "UPDATE users SET added_date = now() where email = '$email'";
...
<body>
    <div class="login_home">
        <div id="login_window" class="login_window">
            ...
            <div class="new_user">
                <p>Register as a Employeer! <span><a href="C_signup.php">SignUp Here!</a></span></p>
            </div>
            <p></p>
