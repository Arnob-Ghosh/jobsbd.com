        ...
        if(!empty($user) && !empty($password))
        {
            if (preg_match($pattern, $email) === 1) 
            {
                if (strlen($password) >= 5){ 
                    ...
                    //save to database
                    $query = "INSERT INTO job_seeker(user, password, email, DOB, address, phone, gender) 
                    VALUES ('$user','$hash','$email','$dateofbirth','$address','$phone','$gender')";
...
<body>
    <div class="login_home">
        <div id="signup_window" class="signup_window">
            ...
            <div class="new_user">
                <p>Already an user? <span><a href="E_login.php">Login Here!</a></span></p>
            </div>
